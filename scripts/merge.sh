...
#hadd -f BsphiKK_MC_nocut.root BsphiKK_470_PIDcut.root BsphiKK_471_PIDcut.root & # 470 and 471 should be identical to 573 and 574. Just processed a year apart.
hadd -f BsphiKK_MC_nocut.root BsphiKK_573_PIDcut.root BsphiKK_574_PIDcut.root BsphiKK_576_PIDcut.root BsphiKK_577_PIDcut.root &
