...
cd ../ntuples/
#Sum of all cuts
totalcut="${trigcut}&&${ghstcut}&&${trackisMuoncut}&&${KpTcut}&&${StdTightKaons}&&${KaonIPCHI2cut}&&${phiIPCHI2cut}&&${KKIPCHI2cut}&&${KKEVCHI2cut}&&${BsFDCHI2cut}&&${BsIPCHI2cut}&&${KpiPIDcut}&&${KpPIDcut}"
###########################################################
